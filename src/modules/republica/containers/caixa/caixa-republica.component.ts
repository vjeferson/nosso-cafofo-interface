...
@Component({
    selector: 'sb-republica-caixa',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './caixa-republica.component.html',
    styleUrls: ['./caixa-republica.component.scss'],
})
export class CaixaRepublicaComponent implements OnInit {
